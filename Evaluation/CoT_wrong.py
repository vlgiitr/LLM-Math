...
from utils.prompting_functions import get_sys_prompt, model_name, chain_of_thought_wrong
...
for model_id in model_ids:
    ...
    for dataset_dir in dataset_dirs:
        ...
        CoT_prompt = chain_of_thought_wrong(dataset_dir)
    ...
    file_path = '/home/aniketa/vlg/copyright-project/shivank/transformers/LLM-Math/Evaluation/Dataset_score' + f'CoT_wrong_{modelname}.json'
