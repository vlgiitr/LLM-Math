...
def save_results(results, output_dir, model_name):
    ...
    output_path = os.path.join(output_dir, f'base_adv_hint_{model_name}.json')
        ...
        for dataset_dir in dataset_dirs:
            ...
            for json_file in os.listdir(dataset_dir):
                ...
                try:
                    ...
                    assistant_response = outputs[0]["generated_text"] if model_id == "meta-llama/Meta-Llama-3.1-8B" else outputs[0]["generated_text"][-1]["content"]
