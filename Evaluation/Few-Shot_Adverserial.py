...
from utils.prompting_functions import get_sys_prompt, get_few_shot_adv_prompt, model_name
...
for model_id in model_ids:
    ...
    for dataset_dir in dataset_dirs:
        ...
        few_shot_prompt = get_few_shot_adv_prompt('train_'+dataset_dir[5:])
        correct_data_eval = 0 
        total_data_eval = 0
    ...
    file_path = 'Evaluation/Dataset_score/' + f'Few-Shot_Adv_{modelname}.json'
