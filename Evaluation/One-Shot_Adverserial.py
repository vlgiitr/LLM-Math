...
from utils.prompting_functions import get_sys_prompt, get_one_shot_adv_prompt, model_name
...
for model_id in model_ids:
    ...
    file_path = 'Evaluation/Dataset_score/' + f'One-Shot_Adv_{modelname}.json'
