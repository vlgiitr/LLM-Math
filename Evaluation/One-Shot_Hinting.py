...
from utils.prompting_functions import get_sys_prompt, model_name, get_one_shot_hint_prompt
...
for model_id in model_ids:
    ...
    for dataset_dir in dataset_dirs:
        ...
        one_shot_prompt = get_one_shot_hint_prompt(dataset_dir)
    ...
    file_path = '/home/aniketa/vlg/copyright-project/shivank/transformers/LLM-Math/Evaluation/Dataset_score' + f'one_shot_hint_{modelname}.json'
