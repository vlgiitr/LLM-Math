...
from utils.prompting_functions import get_sys_prompt, get_few_shot_hinted_prompt, model_name
...
model = AutoModelForCausalLM.from_pretrained(
    eval_model_id, torch_dtype="auto", device_map="auto"
)
...
for model_id in model_ids:
    ...
    for dataset_dir in dataset_dirs:
        ...
        few_shot_prompt = get_few_shot_hinted_prompt('train_'+dataset_dir[5:])
        correct_data_eval = 0 
        total_data_eval = 0
    ...
    file_path = 'Evaluation/Dataset_score/' + f'Few-Shot_Hint_{modelname}.json'
