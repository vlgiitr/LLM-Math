...
from utils.prompting_functions import get_sys_prompt, chain_of_thought_adverserial, model_name
...
for model_id in model_ids:
    ...
    file_path = 'Evaluation/Dataset_score/' + f'CoT_Adv_{modelname}.json'
